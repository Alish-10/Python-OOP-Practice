...
class Car(Vehicle):
    ...
    def __init__(self, form_factor, **kwargs):
        ...
        Args:
            form_factor (str): The form factor of the car (e.g., SUV, Sedan).
            **kwargs: Additional keyword arguments for Vehicle.
        """
...
class Electric(Car):
    """
    Derived class representing an electric car, inherits from Car.
    """
...
class Petrol(Car):
    """
    Derived class representing a petrol car, inherits from Car.
    """
    def __init__(self, max_range, **kwargs):
        super().__init__(**kwargs)
        self.max_range = max_range
...
# Test the classes
# Creating an electric car using only keyword arguments for clarity and compatibility with **kwargs
generic_electric_car = Electric(
    max_range=500,
    form_factor="SUV",
    colour="red",
    weight=1000,
